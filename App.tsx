...
const App: React.FC = () => {
  ...
  return (
    // Removed bg-stone-900 to allow transparency
    <div className="relative w-full h-screen bg-black overflow-hidden">
      ...
      {/* Dark Overlay for Contrast (lighter to see video better) */}
      <div 
        className={`absolute inset-0 bg-stone-950/20 pointer-events-none transition-opacity duration-1000 ${appState === AppState.RUNNING ? 'opacity-100' : 'opacity-0'}`}
      />
